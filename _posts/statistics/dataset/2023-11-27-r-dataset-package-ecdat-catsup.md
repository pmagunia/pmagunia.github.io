...
<p id="dataset-attachments">Attachments: <code><a target="_blank" href="/assets/data/csv/dataset-73484.csv">csv</a></code>, <code><a target="_blank" href="/assets/data/json/dataset-73484.json">json</a></code></p>
